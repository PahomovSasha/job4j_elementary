...
public class JobTest {
    ...
    @Test
    public void whenCompatorBySameNameAndDescPrority() {
        Comparator<Job> cmpNamePriority = new JobDescByName().thenComparing(new JobDescByPriority());
        int rsl = cmpNamePriority.compare(
                new Job("Impl task", 0),
                new Job("Impl task", 1)
    ...
    @Test
    public void whenCompatorBySameNameAndAscPrority() {
        Comparator<Job> cmpNamePriority = new JobDescByName().thenComparing(new JobAscByPriority());
        int rsl = cmpNamePriority.compare(
                new Job("Impl task", 0),
                new Job("Impl task", 1)
    ...
    @Test
    public void whenCompatorByAscNameAndSamePrority() {
    ...
    @Test
    public void whenCompatorByDescNameAndSamePrority() {
