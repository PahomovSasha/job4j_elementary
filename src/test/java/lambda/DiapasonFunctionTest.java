...
import ru.job4j.lambda.DiapasonFunction;
...
public class DiapasonFunctionTest {
    ...
    public void whenLinearFunctionThenQuadraticResults() {
        List<Double> result = DiapasonFunction.diapason(5, 8, x -> x * x + 1);
    ...
    public void whenLinearFunctionThenExponentialResults() {
        List<Double> result = DiapasonFunction.diapason(5, 8, x -> Math.pow(2, x) + 1);
